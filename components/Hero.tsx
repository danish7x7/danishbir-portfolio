    ...
    <section id="home" className="w-full scroll-mt-[150px]">
      ...
      <div className="mt-12 relative">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-8 flex flex-col justify-between md:min-h-[26vw]">
            {/* Headline — top aligned */}
            <h1
              className="font-medium text-white leading-[1.05] tracking-tight max-w-full md:max-w-[60%]"
            ...
            <div className="mt-8 bg-white text-black py-3 px-6 relative z-0 md:-mr-[50%] overflow-hidden">
              <ul className="grid grid-cols-2 gap-x-4 gap-y-2 md:grid-cols-4 w-full">
                <li className="text-xs md:text-sm font-bold uppercase tracking-wide md:whitespace-nowrap">
                  Applied ML
                </li>
                <li className="text-xs md:text-sm font-bold uppercase tracking-wide md:whitespace-nowrap">
