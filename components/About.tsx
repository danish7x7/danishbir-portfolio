    ...
    <section id="about" className="w-full mt-24 pb-[100px] min-h-[100vh] flex flex-col scroll-mt-[150px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch flex-grow">
        ...
        <div className="md:col-span-8 flex flex-col">
          {/* Headline / bio */}
          <h3 className="font-medium text-white leading-[1.15] tracking-tight" style={{ fontSize: "clamp(2.5rem, 2.4vw, 3.5rem)" }}>
          ...
          {/* ======================================= */}
          <div className="mt-12 grid grid-cols-5 grid-rows-2 gap-4">
              {/* Row 1, Col 1 — STUDENT (Playfair serif) */}
            <div className="col-start-1 row-start-1 aspect-square border border-white/20 rounded-2xl flex items-center justify-center">
            ...
            <div className="col-start-3 row-start-1 aspect-square border border-white/20 rounded-2xl flex items-center justify-center">
            ...
            <div className="col-start-5 row-start-1 aspect-square border border-white/20 rounded-2xl flex items-center justify-center">
            ...
            <div className="col-start-2 row-start-2 aspect-square border border-white/20 rounded-2xl flex items-center justify-center">
            ...
            <div className="col-start-4 row-start-2 aspect-square border border-white/20 rounded-2xl flex items-center justify-center">
