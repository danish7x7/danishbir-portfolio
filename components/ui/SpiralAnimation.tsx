...
class AnimationController {
    ...
    private readonly cameraTravelDistance = 5400
    private readonly startDotYOffset = 10
    private readonly viewZoom = 400
    private readonly numberOfStars = 8000
    ...
    // Setup random generator with seed for consistent results
    ...
    // Getter for cameraZ (needed by Star class)
    public getCameraZ(): number {
        return this.cameraZ
    }
    
    // Getter for viewZoom (needed by Star class)
...
class Star {
    ...
    constructor(cameraZ: number, cameraTravelDistance: number) {
        ...
        this.strokeWeightFactor = Math.pow(Math.random(), 5.2)
    }
    ...
    render(p: number, controller: AnimationController) {
        ...
        if (q > 0) {
            ...
            // Mixed easing functions for natural animation
            ...
            // Blend different easing effects
            let easing: number
            ...
            if (displacementProgress < 0.3) {
                ...
                // Middle stage: curve movement (40%)
            ...
            const dotSize = 15.0 * this.strokeWeightFactor * sizeMultiplier
